...
class VoiceAnalysis:
    def __init__(self, device: str = None):
        """
        Enhanced voice analysis combining your sentiment analyzer with speech-to-text
        ...
        # Initialize your sentiment analyzer components
    ...
    def predict_sentiment(self, text: str) -> Tuple[str, Dict[str, float]]:
        """
        Your existing sentiment analysis method with slight enhancements
        
        Args:
            text: Input text to analyze
            
        Returns:
            tuple: (dominant sentiment label, dictionary of scores)
        """
        ...
        # Convert tensor to numpy and then to Python float for JSON serialization
    ...
    def analyze_recording(self, audio_path: str, user_folder: str = None) -> Dict[str, Any]:
        ...
        Args:
            ...
            user_folder: Optional user directory for saving results
    ...
    def save_analysis(self, results: Dict[str, Any], user_folder: str) -> str:
        ...
        Args:
            ...
            user_folder: User's data directory
        ...
        # Create voice analysis subfolder
